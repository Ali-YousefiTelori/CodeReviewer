...
namespace CodeReviewer.Engine
{
    public class CsharpCodeAnalysisManager
    {
        ...
        public static void AddMemberCsharpCodeAnalysisCodeReviewer(IEnumerable<ClassDeclarationSyntax> classes, Func<MemberDeclarationSyntax, (string Prefix, string Suffix)> checkIsValidFunc)
        {
